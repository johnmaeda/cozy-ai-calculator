...
export class AgentSpreadsheet extends LitElement {
  ...
  static styles = css`
    ...
    .demo-banner::before {
      content: "🦄 vibe-coded demo demo demo demo demo demo";
    }
  `;
        ...
        <div class="spreadsheet-container ${this.showDevTools ? "with-dev-tools" : ""}">
          <div class="toolbar">
            <div class="toolbar-left-items">
              ...
              <h4><span style="color:rgb(2, 162, 249);">Azure AI Foundry</span><span style="color: grey;"> Demo | </span> Cozy AI Kitchen 🎂 Calculator</h4>
            </div>
